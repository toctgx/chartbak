...
const SVG_HOME = `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 22l18-16 18 16v20a2 2 0 01-2 2H8a2 2 0 01-2-2V22z" fill="rgba(0,0,0,0.32)"/>
  <path d="M8 23l16-14 16 14v19H8V23z" fill="rgba(0,0,0,0.14)"/>
  <rect x="18" y="30" width="12" height="12" rx="2" fill="rgba(0,0,0,0.28)"/>
</svg>`;

const SVG_HOME_ACTIVE = `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 22l18-16 18 16v20a2 2 0 01-2 2H8a2 2 0 01-2-2V22z" fill="#4A6741"/>
  <path d="M8 23l16-14 16 14v19H8V23z" fill="#7BA374"/>
  <rect x="18" y="30" width="12" height="12" rx="2" fill="#3A5130"/>
</svg>`;

// ── 탭바: 라운지 ──────────────────────────────────────────
const SVG_LOUNGE = `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <circle cx="15" cy="16" r="8" fill="rgba(0,0,0,0.32)"/>
  <circle cx="15" cy="16" r="6" fill="rgba(0,0,0,0.14)"/>
  <circle cx="33" cy="16" r="8" fill="rgba(0,0,0,0.32)"/>
  <circle cx="33" cy="16" r="6" fill="rgba(0,0,0,0.14)"/>
  <path d="M2 40c0-8 5.8-14 13-14h18c7.2 0 13 6 13 14" fill="rgba(0,0,0,0.32)"/>
  <path d="M4 40c0-7 5.4-12 12-12h16c6.6 0 12 5 12 12" fill="rgba(0,0,0,0.14)"/>
</svg>`;

const SVG_LOUNGE_ACTIVE = `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <circle cx="15" cy="16" r="8" fill="#4A6741"/>
  <circle cx="15" cy="16" r="6" fill="#7BA374"/>
  <circle cx="33" cy="16" r="8" fill="#4A6741"/>
  <circle cx="33" cy="16" r="6" fill="#7BA374"/>
  <path d="M2 40c0-8 5.8-14 13-14h18c7.2 0 13 6 13 14" fill="#4A6741"/>
  <path d="M4 40c0-7 5.4-12 12-12h16c6.6 0 12 5 12 12" fill="#7BA374"/>
</svg>`;

// ── 탭바: 마이 ────────────────────────────────────────────
const SVG_MYPAGE = `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <circle cx="24" cy="17" r="10" fill="rgba(0,0,0,0.32)"/>
  <circle cx="24" cy="17" r="8" fill="rgba(0,0,0,0.14)"/>
  <path d="M4 44c0-11 9-20 20-20s20 9 20 20" fill="rgba(0,0,0,0.32)"/>
  <path d="M7 44c0-9.4 7.6-17 17-17s17 7.6 17 17" fill="rgba(0,0,0,0.14)"/>
</svg>`;

const SVG_MYPAGE_ACTIVE = `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <circle cx="24" cy="17" r="10" fill="#4A6741"/>
  <circle cx="24" cy="17" r="8" fill="#7BA374"/>
  <path d="M4 44c0-11 9-20 20-20s20 9 20 20" fill="#4A6741"/>
  <path d="M7 44c0-9.4 7.6-17 17-17s17 7.6 17 17" fill="#7BA374"/>
</svg>`;

// ── 탭바: 한줄일기 ───────────────────────────────────────
const SVG_DIARY = `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <rect x="8" y="4" width="28" height="36" rx="4" fill="rgba(0,0,0,0.32)"/>
  <rect x="9" y="5" width="26" height="34" rx="3" fill="rgba(0,0,0,0.14)"/>
  <line x1="14" y1="16" x2="32" y2="16" stroke="rgba(0,0,0,0.28)" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="14" y1="22" x2="32" y2="22" stroke="rgba(0,0,0,0.28)" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="14" y1="28" x2="24" y2="28" stroke="rgba(0,0,0,0.28)" stroke-width="2.5" stroke-linecap="round"/>
  <circle cx="36" cy="36" r="8" fill="rgba(0,0,0,0.18)"/>
  <line x1="33" y1="36" x2="39" y2="36" stroke="rgba(0,0,0,0.28)" stroke-width="2" stroke-linecap="round"/>
  <line x1="36" y1="33" x2="36" y2="39" stroke="rgba(0,0,0,0.28)" stroke-width="2" stroke-linecap="round"/>
</svg>`;

const SVG_DIARY_ACTIVE = `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <rect x="8" y="4" width="28" height="36" rx="4" fill="#4A6741"/>
  <rect x="9" y="5" width="26" height="34" rx="3" fill="#7BA374"/>
  <line x1="14" y1="16" x2="32" y2="16" stroke="#3A5130" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="14" y1="22" x2="32" y2="22" stroke="#3A5130" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="14" y1="28" x2="24" y2="28" stroke="#3A5130" stroke-width="2.5" stroke-linecap="round"/>
  <circle cx="36" cy="36" r="8" fill="#4A6741"/>
...
const SVG_PATIENT = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <circle cx="12" cy="8" r="5" fill="#4A6741"/>
  <circle cx="12" cy="8" r="3.5" fill="#7BA374"/>
  <path d="M3 21c0-5 4-9 9-9s9 4 9 9" fill="#4A6741"/>
...
const SVG_CAREGIVER = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <circle cx="8" cy="7" r="4" fill="#6B7280"/>
  <circle cx="8" cy="7" r="2.8" fill="#9CA3AF"/>
  <circle cx="16" cy="7" r="4" fill="#6B7280"/>
  <circle cx="16" cy="7" r="2.8" fill="#9CA3AF"/>
  <path d="M1 21c0-4 3.1-7 7-7h8c3.9 0 7 3 7 7" fill="#6B7280"/>
</svg>`;
...
const SVG_SAME_ON = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <circle cx="8" cy="7" r="3.5" fill="#4A6741"/>
  <circle cx="8" cy="7" r="2.5" fill="#7BA374"/>
  <circle cx="16" cy="7" r="3.5" fill="#4A6741"/>
  <circle cx="16" cy="7" r="2.5" fill="#7BA374"/>
  <path d="M2 19c0-4 2.7-7 6-7h8c3.3 0 6 3 6 7" fill="#4A6741"/>
</svg>`;
...
const SVG_CHEER_ON = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <rect x="6" y="10" width="12" height="10" rx="3" fill="#4A6741"/>
  <rect x="7" y="11" width="10" height="8" rx="2" fill="#7BA374"/>
  <rect x="7.5" y="6.5" width="3" height="5" rx="1.5" fill="#4A6741"/>
  <rect x="11.5" y="5.5" width="3" height="6" rx="1.5" fill="#4A6741"/>
  <rect x="15.5" y="6.5" width="3" height="5" rx="1.5" fill="#4A6741"/>
  <rect x="4" y="11" width="3" height="5" rx="1.5" fill="#4A6741"/>
</svg>`;

// ── 글 유형 ───────────────────────────────────────────────
const SVG_TYPE_TREATMENT = `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
  <rect x="5" y="4" width="20" height="24" rx="4" fill="#4A6741"/>
  <rect x="6" y="5" width="18" height="22" rx="3" fill="white"/>
  <line x1="9" y1="12" x2="21" y2="12" stroke="#4A6741" stroke-width="2" stroke-linecap="round"/>
  <line x1="9" y1="17" x2="21" y2="17" stroke="#4A6741" stroke-width="2" stroke-linecap="round"/>
  <line x1="9" y1="22" x2="16" y2="22" stroke="#4A6741" stroke-width="2" stroke-linecap="round"/>
  <rect x="12" y="1" width="6" height="5" rx="2.5" fill="#3A5130"/>
</svg>`;

const SVG_TYPE_UNSAID = `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
  <path d="M4 5h20c1.7 0 3 1.3 3 3v13c0 1.7-1.3 3-3 3H18l-5 4-5-4H4c-1.7 0-3-1.3-3-3V8c0-1.7 1.3-3 3-3z" fill="#4A6741"/>
  <path d="M5 6h18c1.4 0 2.5 1.1 2.5 2.5v12c0 1.4-1.1 2.5-2.5 2.5H17.5l-4.5 3.5-4.5-3.5H5c-1.4 0-2.5-1.1-2.5-2.5v-12C2.5 7.1 3.6 6 5 6z" fill="#7BA374"/>
...
const SVG_TYPE_QUESTION = `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
  <circle cx="16" cy="16" r="14" fill="#4A6741"/>
  <circle cx="16" cy="16" r="12" fill="#7BA374"/>
...
const SVG_TYPE_HOSPITAL = `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
  <rect x="4" y="12" width="20" height="17" rx="2" fill="#4A6741"/>
  <rect x="5" y="13" width="18" height="15" rx="1.5" fill="#7BA374"/>
  <rect x="4" y="5" width="20" height="10" rx="2" fill="#3A5130"/>
...
const SVG_SEARCH_ACTIVE = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <circle cx="11" cy="11" r="7" stroke="#4A6741" stroke-width="2.5" fill="none"/>
  <line x1="16.5" y1="16.5" x2="21" y2="21" stroke="#4A6741" stroke-width="2.5" stroke-linecap="round"/>
</svg>`;
