      ...
      <View style={styles.content}>
        ...
        >
          ...
          <View style={styles.cardText}>
            <Text style={[
              styles.cardTitle,
              selected === 'patient' && { color: COLORS.patient }
            ]}>
              환자 (본인)
            </Text>
          ...
          <View style={[
            styles.radio,
            selected === 'patient' && { backgroundColor: COLORS.patient, borderColor: COLORS.patient }
          ]}>
        ...
        >
          ...
          <View style={styles.cardText}>
            <Text style={[
              styles.cardTitle,
              selected === 'caregiver' && { color: COLORS.caregiver }
            ]}>
              환우 (보호자)
            </Text>
            <Text style={styles.cardDesc}>
          ...
          <View style={[
            styles.radio,
            selected === 'caregiver' && { backgroundColor: COLORS.caregiver, borderColor: COLORS.caregiver }
          ]}>
